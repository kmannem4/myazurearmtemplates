...
cd 'BuildOutput\Artifacts\src\ARM\Infrastructure\Environments\TTMInsightsUI\TEST'

#Connect-AzAccount
Set-AzContext -Subscription 'AMN Shiftwise Dev'

$ResourceGroupName = 'amn-wus2-ttm-rg-t01'
$ResourceGroupLocation = 'WestUS2'
$storageAccountName = "amnttminsightssat01"
