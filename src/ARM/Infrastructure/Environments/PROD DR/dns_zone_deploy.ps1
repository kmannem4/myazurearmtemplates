...
cd 'BuildOutput\Artifacts\src\ARM\Infrastructure\Environments\PROD DR'
...
Set-AzContext -Subscription 'AMN Shared Services'

#Please Verify the Resource Group name correctly before commiting changes
$ResourceGroupName = 'co-wus2-dnszones-rg-s01'
