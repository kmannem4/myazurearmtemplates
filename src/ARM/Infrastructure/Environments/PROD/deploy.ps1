...
cd 'BuildOutput\Artifacts\src\ARM\Infrastructure\Environments\PROD'
...
Set-AzContext -Subscription 'AMN Intelligent Platform Services Prod'

#Please Verify the Resource Group name correctly before commiting changes
$ResourceGroupName = 'amn-wus2-hub-rg-p01'
...
#& $TemplatePath\Environments\PROD\prod_ttm_amnhealthcare_cert.ps1
#& $TemplatePath\Environments\PROD\shiftwise_wildcard_cert.ps1
...
#& $TemplatePath\Environments\PROD\dns_zone_deploy.ps1
