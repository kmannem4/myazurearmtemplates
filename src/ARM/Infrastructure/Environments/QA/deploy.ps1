...
$ResourceGroupName = 'amn-wus2-hub-rg-q01'
...
#& $TemplatePath\Environments\qa\qa_ttm_amnhealthcare_cert.ps1
#& $TemplatePath\Environments\qa\shiftwise_wildcard_cert.ps1
...
#& $TemplatePath\Environments\qa\dns_zone_deploy.ps1
