...
cd 'BuildOutput\Artifacts\src\ARM\Infrastructure\Environments\TEST'
...
$ResourceGroupName = 'amn-wus2-hub-rg-t01'
...
#& $TemplatePath\Environments\TEST\dev_ttm_amnhealthcare_cert.ps1
#& $TemplatePath\Environments\TEST\shiftwise_wildcard_cert.ps1
...
#& $TemplatePath\Environments\TEST\dns_zone_deploy.ps1
